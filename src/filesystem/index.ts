export const PAGE_OUTPUT: Record<string, string> = {
  "/": `Welcome to axjns.dev\nType a command or use the menu above.\n\nLatest:\n  → type 'blog' to read blog posts\n  → type 'research' to browse papers\n  → or visit https://axjns.dev/blog`,
