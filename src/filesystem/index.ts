export const PAGE_OUTPUT: Record<string, string> = {
  "/": `Welcome to axjns.dev\nType a command or use the menu above.\n\nLatest research:\n  → type 'research' to browse articles\n  → or visit https://axjns.dev/research`,
...
`,
  ...
  '/etc/motd': '┌─────────────────────────────────────────────────┐\n│                                                 │\n│    ████  ██   ██      ██ ███   ██ ████          │\n│   ██  ██  ██ ██       ██ ████  ██ ██            │\n│   ██████   ███        ██ ██ ██ ██  ████         │\n│   ██  ██  ██ ██   ██  ██ ██  ████    ██         │\n│   ██  ██ ██   ██   ████  ██   ███ ████   .dev  │\n│                                                 │\n│   ══════════════════════════════════════════     │\n│   Hack the planet. Deploy on Fridays.           │\n│   ══════════════════════════════════════════     │\n│                                                 │\n│   SysOp: Alex Jones                             │\n│   Nodes: 1    Lines: 42    Since: 2024          │\n│                                                 │\n│   "The cloud is just someone else\'s computer."  │\n│                                                 │\n│   NEW! type \'research\' for latest articles       │\n│   hint: the man pages know things. try man init │\n│                                                 │\n│   strstrstr Best viewed in Netscape Navigator 4.0      │\n└─────────────────────────────────────────────────┘',
